...
func Routers() *gin.Engine {
	...
	// 图片上传
	PublicGroup.POST("/uploadImg", v1.FileUpload)
	PublicGroup.POST("/uploadImgFull", v1.FileUploadFull)
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		router.InitSysArticlesCagetoryRouter(PrivateGroup) // 文章分类
		router.InitSysArticlesRouter(PrivateGroup)
		router.InitExaExampleTestRouter(PrivateGroup) // 示例测试
		router.InitUsUserRouter(PrivateGroup) // 用户列表
